...
class getPortalEntityById
{
    ...
    public function resolve()
    {
        ...
        $entity = new \LwPortalList\Model\Portal\Object\Portal($this->params["id"]);
    ...
    {
        if($piwik_id > 0){
            $response = \LwPortalList\Model\Piwik\CommandResolver\getPiwikSiteById::getInstance(array("id" => $piwik_id))->resolve();
